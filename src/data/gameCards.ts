...
export const gameCards: GameCard[] = [
  {
    ...
    leftChoice: {
      ...
      effects: { budget: 12, audience: 2, satisfaction: -3, technology: 2 },
      consequence: 'Economizou R$ 7.000, mas localização afetou um pouco a presença. Transporte público limitado.',
    ...
    rightChoice: {
      ...
      effects: { budget: -18, audience: 18, satisfaction: 15, technology: 8 },
      consequence: 'Investimento alto, mas excelente presença. Localização facilitou parcerias locais.',
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: -18, audience: 10, satisfaction: 4, technology: 3 },
    ...
    rightChoice: {
      ...
      effects: { budget: -15, audience: 18, satisfaction: 12, technology: 15 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: 12, audience: 15, satisfaction: 6, technology: 5 },
    ...
    rightChoice: {
      ...
      effects: { budget: 6, audience: 8, satisfaction: 12, technology: 3 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: 6, audience: 4, satisfaction: 2, technology: 3 },
    ...
    rightChoice: {
      ...
      effects: { budget: -15, audience: 15, satisfaction: 12, technology: 20 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: 10, audience: -6, satisfaction: -8, technology: 10 },
      consequence: 'Economizou R$ 800 em taxas, mas perdeu algumas vendas. Público mais velho ficou excluído.',
    ...
    rightChoice: {
      ...
      effects: { budget: -12, audience: 25, satisfaction: 20, technology: 18 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: -35, audience: 15, satisfaction: 8, technology: 2 },
    ...
    rightChoice: {
      ...
      effects: { budget: -12, audience: 8, satisfaction: 25, technology: 18 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: -5, audience: -4, satisfaction: -2, technology: 22 },
      consequence: 'Coletou dados qualificados, mas alguns desistiram da compra. Dados ricos, mas pequeno impacto nas vendas.',
    ...
    rightChoice: {
      ...
      effects: { budget: -15, audience: 15, satisfaction: 22, technology: 18 },
      consequence: 'Poucos responderam, mas dados super qualificados. Gasto em incentivos gerou goodwill positivo.',
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: -3, audience: -2, satisfaction: -4, technology: 8 },
      consequence: 'Virou debate público! Alguns apoiaram, mas imagem ficou um pouco associada ao conflito.',
    ...
    rightChoice: {
      ...
      effects: { budget: -10, audience: 22, satisfaction: 20, technology: 15 },
      consequence: 'Influenciador virou embaixador! Postou story positivo elogiando o atendimento. Crise virou oportunidade.',
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: 15, audience: 8, satisfaction: -5, technology: 3 },
    ...
    rightChoice: {
      ...
      effects: { budget: 10, audience: 15, satisfaction: 20, technology: 12 },
  ...
  },
  {
    ...
    leftChoice: {
      ...
      effects: { budget: -10, audience: 15, satisfaction: 25, technology: 20 },
    ...
    rightChoice: {
      ...
      effects: { budget: 12, audience: 25, satisfaction: 5, technology: 5 },
...
export const randomEvents = [
  {
    ...
    effects: { budget: -20, satisfaction: -12 },
  ...
  },
  {
    ...
    effects: { audience: 25, satisfaction: 15 },
  ...
  },
  {
    ...
    effects: { budget: -15, satisfaction: -18, technology: -12 },
  ...
  },
  {
    ...
    effects: { budget: 15, technology: 10 },
    message: 'Patrocinador ficou tão satisfeito que dobrou o investimento! Recursos extras na conta.'
  },
  {
    id: 'supply-shortage',
    title: 'Falta de Fornecedores',
    description: 'Fornecedor de equipamentos cancelou na última hora!',
    effects: { budget: -25, technology: -15 },
    message: 'Teve que contratar fornecedor de emergência com 40% de sobretaxa.'
  },
  {
    id: 'competitor-event',
    title: 'Evento Concorrente',
    description: 'Um evento similar foi marcado no mesmo dia!',
    effects: { audience: -15, satisfaction: -8 },
    message: 'Concorrência dividiu o público. Alguns participantes cancelaram.'
  }
];

export const INITIAL_METRICS = {
  budget: 105,  // Reduzido um pouco para mais tensão
  audience: 8,  // Base inicial menor
  satisfaction: 8, // Base inicial menor
  technology: 0
};
